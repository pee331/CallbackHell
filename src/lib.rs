...
#[derive(Debug)]
pub struct CallbackHellProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CallbackHellProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CallbackHell processing");
    
    let mut processor = CallbackHellProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CallbackHellProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CallbackHellProcessor::new(false);
